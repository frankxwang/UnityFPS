...
extern "C"  float Mathf_SmoothDampAngle_m3226502443 (Il2CppObject * __this /* static, unused */, float ___current0, float ___target1, float* ___currentVelocity2, float ___smoothTime3, float ___maxSpeed4, const MethodInfo* method) IL2CPP_METHOD_ATTR;
