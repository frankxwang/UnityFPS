...
struct  PendingOwner_t312816508 
{
public:
...
public:
	inline static int32_t get_offset_of_netId_0() { return static_cast<int32_t>(offsetof(PendingOwner_t312816508, ___netId_0)); }
	...
	inline static int32_t get_offset_of_playerControllerId_1() { return static_cast<int32_t>(offsetof(PendingOwner_t312816508, ___playerControllerId_1)); }
...
#endif
// Native definition for marshalling of: UnityEngine.Networking.ClientScene/PendingOwner
struct PendingOwner_t312816508_marshaled_pinvoke
{
	NetworkInstanceId_t3860307911_marshaled_pinvoke ___netId_0;
	int16_t ___playerControllerId_1;
};
// Native definition for marshalling of: UnityEngine.Networking.ClientScene/PendingOwner
struct PendingOwner_t312816508_marshaled_com
{
	NetworkInstanceId_t3860307911_marshaled_com ___netId_0;
	int16_t ___playerControllerId_1;
};
